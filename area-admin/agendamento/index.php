        ...
        <div class=" row">
          <table class="table table-hover">
            <thead>
              ...
              <td><?= date('H:i', strtotime($agendamento['horaAgendamento'])) ?></td>
              <td><?= $agendamento['descPet'] ?></td>
                <td><?= $agendamento['obsAgendamento'] ?></td>
                ...
                <td class="text-center ">
                  <a class="dropdown-item" onclick="modalRemover(<?=$agendamento['codAgendamento']?>,'codDeletar')">
