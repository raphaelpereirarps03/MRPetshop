          ...
          <table class="table table-hover">
            <thead>
              ...
              <tr>
                <td><?=$raca['codRaca']?></td>
                <td><?=$raca['descRaca']?></td>
                <td><?=$raca['descEspecie']?></td>
                <td class="text-center">
                  <form action="process-raca.php" method="POST">
                    <input type="hidden" class="form-control" id="acao" name="acao" value="SELECTID">
                    <input type="hidden" class="form-control" id="id" name="id" value="<?=$raca['codRaca']?>">
                ...
                <td class="text-center ">
                  <a class="dropdown-item" onclick="modalRemover(<?=$raca['codRaca']?>,'codDeletar')">
